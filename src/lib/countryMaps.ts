...
export type CountryMap = {
  ...
  /**
   * A point well inside the country's largest landmass, for the stand-in pin
   * a country gets when we know we shipped there but not to which town.
   *
   * The centroid of the LARGEST polygon, not of the country: New Zealand's
   * true centroid is in Cook Strait and France's would be pulled off-centre by
   * Corsica. Verified to sit inside the outline, and the generator falls back
   * to a deepest-interior-point search for any shape concave enough that its
   * centroid escapes. Clearances at the drawn size: France 27px from the
   * nearest coast, Germany 21, Australia 18, Austria 15, New Zealand 7.
   */
