...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    //
    // 1200x630, generated by scripts/make-og-images.py from
    // public/images-2/shorts-holdinghands.jpg. To change the picture, swap the
    // source photo in that script — don't point this at a file in images-2
    // directly. The source here is 6240x4160 and 12.5 MB: past Facebook's 8 MB
    // ceiling, and slow enough that iMessage, WhatsApp and Slack give up before
    // the image finishes downloading, so the link previews with no image at all.
    images: [{ url: '/og/home-og.jpg', width: 1200, height: 630, alt: 'Two women in Tualmi shorts holding hands on a golden hillside' }],
  },
  twitter: {
